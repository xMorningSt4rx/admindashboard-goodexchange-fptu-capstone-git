...
export const FormatVietnamTime = (dateString) => {
    const isoDateTime = DateTime.fromISO(dateString, { zone: "utc" });
    const vietnamDateTime = isoDateTime.minus({ hours: 7 });
    const vietnamTime = vietnamDateTime.toFormat("HH:mm");
    return vietnamTime;
};
...
export const FormatVietnamHour = (dateString) => {
    const isoDateTime = DateTime.fromISO(dateString, { zone: "utc" });
    const vietnamDateTime = isoDateTime.minus({ hours: 7 });
    const vietnamTime = vietnamDateTime.toFormat("HH");
    return vietnamTime;
};
